...
class serviceController extends Controller
{
    ...
    public function updateNumberManagerByUniqueId($uniqueId)
    {
        $service = Service::where('uniqueId', $uniqueId)->update([
            'numberManager' => 0,
        ]);
    ...
    public function updateNumberManagerById(Request $request, $id)
    {
        $service = Service::find($id)->update([
            'numberManager' => $request->input('numberManager')
        ]);
    ...
    public function updateNumberTherapistByUniqueId($uniqueId)
    {
        $service = Service::where('uniqueId', $uniqueId)->update([
            'numberTherapist' => 0,
        ]);
    ...
    public function updateNumberTherapistById(Request $request, $id)
    {
        $service = Service::find($id)->update([
            'numberTherapist' => $request->input('numberTherapist')
        ]);
    ...
    public function updateNumberTaxiByUniqueId($uniqueId)
    {
        $service = Service::where('uniqueId', $uniqueId)->update([
            'numberTaxi' => 0,
        ]);
    ...
    public function updateNumberTaxiById(Request $request, $id)
    {
        $service = Service::find($id)->update([
            'numberTaxi' => $request->input('numberTaxi')
        ]);
